...
-apply speed
- resolve collision
- update position + set position + update speed for next iteration

// NOTES:
+ an item won't push the others in the current iteration
+ in the next iteration if an item was pushed it will take it into consideration in the current iteration

+ Later: If works fine (using weigh_1>weight_2 -> 1 pushes 2) use conservative momentum + kinematic energy conservation ...
