...
EntityDynamics::EntityDynamics(QGraphicsItem *parent, qreal init_speed_x, qreal init_speed_y, qreal weight, qreal friction, bool change_mvmt_dir, qreal speed_max_x, qreal speed_max_y)
{
...
//    qDebug()<<m_speed_max_x<<m_speed_max_y<<m_accel_max_x<<m_accel_max_y;
    ...
    m_collision_rect = new CollisionRect(parent, m_speed_x, m_speed_y, weight);
